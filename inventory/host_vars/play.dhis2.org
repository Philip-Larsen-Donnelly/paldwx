...
instance_manager_overrides:
  - name: dev
    description: "Cutting edge DHIS 2 development snapshot (running on Instance Manager)"
  ...
  - name: 2.40dev
    description: "Build of the DHIS 2 version 2.40 development snapshot (running on Instance Manager)"
    ...
    postgresql_version: 13
  - name: 2.39dev
    description: "Build of the DHIS 2 version 2.39 development snapshot (running on Instance Manager)"
    ...
    postgresql_version: 13
  - name: 2.38dev
    description: "Build of the DHIS 2 version 2.38 development snapshot (running on Instance Manager)"
