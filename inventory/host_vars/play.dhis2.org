...
instance_manager_overrides:
  ...
  - name: 2.39dev
    ...
    postgresql_version: 13
  - name: 2.38dev
    description: "Build of the DHIS 2 version 2.38 development snapshot"
  ...
  - name: 2.39nightly
    ...
    postgresql_version: 13
  - name: 2.38nightly
    description: "Demo of DHIS 2 version 38 latest nightly build"
  ...
  - name: 41.0.0
    ...
    im_url: https://play.im.dhis2.org/stable-2-41-0
    type: "Stable"
    installed_by: "instance-manager"
    docker_image: "dhis2/core:41.0.0"
  ...
  - name: 2.39.5
    ...
    postgresql_version: 13
  - name: 2.38.6
    description: "Demo of DHIS 2 version 38 latest stable patch"
